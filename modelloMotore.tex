...
\end{figure}
\noindent Il LEGO MINDSTORMS EV3 è dotato di un motore, l'EV3 Large Servo Motor, la cui velocità angolare, misurata in $deg/s$, è stata assunta come uscita del sistema mostrato in figura \ref{motoreSimulink}.\\
