...
In figura \ref{pendoloFisico} realizzazione del pendolo su carrello utilizzando un motore EV3 Large Servo Motor come trazione e un encoder GlideWheel-M per misurare l'angolo del pendolo rispetto alla verticale.
\begin{figure}[ht]
	\centering
...
\begin{figure}[ht]
	...
	\label{Sistema Retroazionato algebricamente}
\end{figure}
